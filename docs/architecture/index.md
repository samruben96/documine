...
- [Architecture](#table-of-contents)
  ...
  - [Architecture Decision Records (ADRs)](./architecture-decision-records-adrs.md)
    ...
    - [ADR-002: Docling for PDF Processing (SUPERSEDED)](./architecture-decision-records-adrs.md#adr-002-docling-for-pdf-processing-superseded-2025-12-05)
    ...
    - [ADR-009: Google Cloud Document AI (Epic 12)](./architecture-decision-records-adrs.md#adr-009-google-cloud-document-ai-for-pdf-processing-epic-12)
