...
2. Add source citations throughout Dev Notes:
   ...
   - `[Source: docs/sprint-artifacts/story-11.4-processing-queue-visualization.md]`
   - `[Source: docs/sprint-artifacts/story-11.3-reliable-job-recovery.md]` (error patterns)
