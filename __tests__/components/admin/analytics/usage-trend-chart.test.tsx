 ...
 * - View mode toggle for primary/all features
 */

import { describe, it, expect, vi } from 'vitest';
import { render, screen } from '@testing-library/react';
import { UsageTrendChart } from '@/components/admin/analytics/usage-trend-chart';
...
describe('UsageTrendChart', () => {
  ...
  it('renders with default title and description', () => {
    ...
    expect(
      screen.getByText('Daily activity across all features')
    ).toBeInTheDocument();
  });
  ...
  it('line names are correctly set', () => {
    ...
    // Story 21.5: Line was renamed from "Conversations" to "AI Buddy"
    expect(activeUsersLine).toHaveAttribute('data-name', 'Active Users');
    expect(conversationsLine).toHaveAttribute('data-name', 'AI Buddy');
  });
});
