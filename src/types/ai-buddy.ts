 ...
 * Story 21.5: Extended for multi-feature tracking
 */
export interface UsageSummary {
  ...
  messagesSent: number;
  /** Story 21.5: Comparison creations across agency */
  comparisonsCreated?: number;
  /** Story 21.5: One-pager generations across agency */
  onePagersGenerated?: number;
  /** Story 21.5: Document chat sessions (distinct from AI Buddy) */
  documentChatSessions?: number;
  ...
  comparisonPeriod?: {
    ...
    documents: number;
    messages: number;
    /** Story 21.5: Comparison change percentage */
    comparisons?: number;
    /** Story 21.5: One-pager change percentage */
    onePagers?: number;
    /** Story 21.5: Document chat change percentage */
    documentChats?: number;
  };
}
...
export interface UserUsageStats {
  ...
  messages: number;
  documents: number;
  /** Story 21.5: Comparisons created by this user */
  comparisons?: number;
  /** Story 21.5: One-pagers generated by this user */
  onePagers?: number;
  /** Story 21.5: Document chat sessions by this user */
  documentChats?: number;
  lastActiveAt: string | null;
}
 ...
 * Story 21.5: Extended for multi-feature trends
 */
export interface UsageTrend {
  ...
  conversations: number;
  messages?: number;
  /** Story 21.5: Document uploads per day */
  documents?: number;
  /** Story 21.5: Comparisons created per day */
  comparisons?: number;
  /** Story 21.5: One-pagers generated per day */
  onePagers?: number;
  /** Story 21.5: Document chat sessions per day */
  documentChats?: number;
}
