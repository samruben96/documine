        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-muted-foreground max-w-sm">
              Once your team starts using docuMINE, you&apos;ll see usage metrics, trends, and
              per-user breakdowns here.
            </p>
            <p className="text-sm text-muted-foreground mt-4">
              Track activity across AI Buddy, document uploads, comparisons, one-pagers, and more.
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <UsageStatCard
            ...
            changePercent={summary?.comparisonPeriod?.comparisons}
            changeLabel="vs previous period"
            isLoading={isLoading}
            testId="stat-comparisons"
          />
          <UsageStatCard
            title="One-Pagers Generated"
            value={summary?.onePagersGenerated || 0}
            icon={<FileSpreadsheet className="h-4 w-4" />}
            changePercent={summary?.comparisonPeriod?.onePagers}
            changeLabel="vs previous period"
            isLoading={isLoading}
            testId="stat-onepagers"
          />
          <UsageStatCard
            title="Document Chat Sessions"
            value={summary?.documentChatSessions || 0}
            icon={<MessageCircle className="h-4 w-4" />}
            changePercent={summary?.comparisonPeriod?.documentChats}
            changeLabel="vs previous period"
            isLoading={isLoading}
            testId="stat-docchats"
          />
        </div>
