...
/**
 * Action category for filtering (Story 21.4)
 */
export type ActionCategory = 'all' | 'document' | 'comparison' | 'one-pager' | 'chat' | 'ai-buddy' | 'admin';
...
export interface AuditLogFilters {
  ...
  /** Story 21.4: Action category filter */
...
export function AuditFilters({
  ...
  // Handle action category selection (Story 21.4)
  const handleActionCategoryChange = useCallback((value: string) => {
    onFiltersChange({
      ...filters,
      actionCategory: value === 'all' ? undefined : (value as ActionCategory),
    });
  }, [filters, onFiltersChange]);
  ...
  return (
    ...
    >
      {/* First row: User dropdown, Action category, and search */}
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        {/* Action category filter (Story 21.4: AC-21.4.5) */}
        <Select
          value={filters.actionCategory || 'all'}
          onValueChange={handleActionCategoryChange}
        >
          <SelectTrigger className="w-full sm:w-[180px]" data-testid="action-category-filter">
